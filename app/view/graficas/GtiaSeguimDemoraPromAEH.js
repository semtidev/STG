Ext.define('SEMTI.view.graficas.GtiaSeguimDemoraPromAEH', {
    extend: 'Ext.Panel',
    id: 'GtiaSeguimDemoraPromAEH',
    alias: 'widget.GtiaSeguimDemoraPromAEH',
    frame: false,
    ...
    listeners: {
        'afterrender': function(view) {
            ...
            var loadMeta =  new Ext.data.JsonStore({
                                // store configs
                                storeId: 'ChartSDDemoraAEHMetaStore',                            
                                proxy: {
                                    type: 'ajax',
                                    url: './php/graficas/store_SDDemoraAEHMeta.php',
                                    reader: {
                                        type: 'json',
                                        root: 'sddemoraeh',
                                        idProperty: 'meta'
                                ...
                                listeners: {
                                    load: function(thisStore, records, options) {
                                        ...
                                        Ext.getCmp('ChartSDDemoraAEHField').setText('Meta: ' + meta);                                      
                                    }
                                }
                            });
    ...
    items: [{
            xtype: 'box',
            id: 'iframeSDDemoraAEHChart',
            minHeight: 580,
            padding: 0,
            renderTo: Ext.getBody(),
            autoEl: {
                tag: 'iframe',
                src: 'http://'+localStorage.getItem('ipserver')+'/semti.garantia/php/graficas/sd_demora_aeh.php'
            }
        }],
    ...
    initComponent: function() {
        ...
        this.dockedItems = [{
                ...
                items: [comboProyects, comboEstado, comboTipo, '->', /*{
                        xtype: 'label',
                        name: 'meta',
                        id: 'ChartSDDemoraAEHField',
                        width: 110
                    },*/{
                        xtype: 'datefield',
                        id: 'ChartDemSDAehStart',
                        fieldLabel: 'Desde',
                        labelWidth: 40,
                        editable: true,
                        width: 150,
