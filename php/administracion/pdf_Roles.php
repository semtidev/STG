...
<table id="header_tabla" width="100%" cellspacing="0" cellpadding="0">
  <tr>
    <td class="title_document">Roles de Usuario del Sistema</td>
    <td width="200" align="right">Fecha: '.$fecha.'</td>
  </tr>
</table>
<table id="header_tabla" width="100%" cellspacing="0" cellpadding="0">
  <tr>
    <td class="enc_tabla" width="300">Nombre</td>
    <td class="enc_tabla">Descripci&oacute;n</td>
  </tr>';
...
$mpdf->Output('Perfiles Garantia.pdf', 'I');
exit;
