...
$mpdf=new mPDF('utf-8', 'LETTER-L'); // Especificando las dimenciones de la pagina   mPDF('utf-8', array(279,216))
...
//$mpdf->AddPage('utf-8', array(279,216)); // Margenes(20,20 -> Left, Right)
