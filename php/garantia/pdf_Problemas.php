...
$sql = "SELECT descripcion FROM gtia_problemas ORDER BY descripcion ASC";
...
<table id="header_tabla" width="100%" cellspacing="0" cellpadding="0">
  <tr>
    <td class="title_document">Tipos de Problemas en SD</td>
...
$mpdf->Output('Tipos de Problemas Garantia.pdf', 'I');
exit;
