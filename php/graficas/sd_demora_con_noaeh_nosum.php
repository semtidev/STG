...
if(!isset($_GET['titulo'])){
    $title = 'Demora Promedio en Reportes Const/No AEH/No Sumin';
}
else{
    $title = $_GET['titulo'];
}
...
// Meta
$sql_meta = "SELECT meta FROM gtia_indicadores WHERE nombre = 'Demora Promedio en SD Const, no AEH y no Sumin'";
$qry_meta = $adoMSSQL_SEMTI->Execute($sql_meta);
$textmeta = $qry_meta->fields[0];
...
<html>
    <head>
        ...
        <title>Demora Promedio en Reportes Const/No AEH/No Sumin</title>
