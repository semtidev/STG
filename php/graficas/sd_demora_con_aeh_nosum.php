...
if(!isset($_GET['titulo'])){
    $title = 'Demora Promedio en Reportes Const/AEH/No Sumin';
}
else{
    $title = $_GET['titulo'];
}
...
// Meta
$sql_meta = "SELECT meta FROM gtia_indicadores WHERE nombre = 'Demora Promedio en SD Const, AEH y no Sumin'";
...
<html>
    <head>
        ...
        <title>Demora Promedio en Reportes Const/AEH/No Sumin</title>
