...
if(!isset($_GET['titulo'])){
    $title = 'Demora Promedio en la Solución de los Reportes AEH';
}
else{
    $title = $_GET['titulo'];
}
...
// Meta
$sql_meta = "SELECT meta FROM gtia_indicadores WHERE nombre = 'Demora Promedio en SD AEH'";
...
<html>
    <head>
        ...
        <title>Demora Promedio en la Solución de los Reportes AEH</title>
