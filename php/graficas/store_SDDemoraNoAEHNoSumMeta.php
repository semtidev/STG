...
$qry_meta = $adoMSSQL_SEMTI->Execute("SELECT meta FROM gtia_indicadores WHERE nombre = 'Demora Promedio en SD Const, no AEH y no Sumin'");

$meta     = $qry_meta->fields[0];
$response = '{ sddemoranoaehnosum: [{"meta": "'.$meta.'"}] }';
echo $response;